...
Fift also includes a macro assembler for TVM code, which is a common intermediate target of higher-level languages such as [Tolk](/languages/tolk) and [FunC](/languages/func/overview), as well as a common textual bitcode representation of smart contracts. For more examples of the latter, see [various blockchain explorers](/ecosystem/explorers/overview) and disassembled smart contracts.
