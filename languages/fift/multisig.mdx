...
- How to deploy a multisig wallet using the Lite client.
...
After starting the Lite client, it's best to run the `time` command in the `lite-client` console to make sure the connection was successful:
