...
- If a slice is too small or contains extra data, `fromSlice` throws.
...
In most cases, this is acceptable. For incoming messages, all fields are typically used; otherwise, the field would not be part of the struct. Extra data in the input is typically harmless. The message can still be deserialized correctly.
