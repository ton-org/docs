...
This page embeds the basic jetton and NFT contract examples from [`ton-blockchain/tolk-bench`](https://github.com/ton-blockchain/tolk-bench), extracted from commit [`cb9648b`](https://github.com/ton-blockchain/tolk-bench/tree/cb9648bdf936f88eb9d773d9058405f74a1e24d9).

Each accordion contains one source file with its original filename. Copy the blocks into files with the same names to recreate the original contract layout.

## Jetton

Source directory in `tolk-bench`: [`contracts_Tolk/01_jetton`](https://github.com/ton-blockchain/tolk-bench/tree/cb9648bdf936f88eb9d773d9058405f74a1e24d9/contracts_Tolk/01_jetton)

```text title="File layout"
01_jetton/
  errors.tolk
...
Not runnable as a single file. Use all files in this section together.

<AccordionGroup>
  <Accordion
    title="errors.tolk"
  >
    ```tolk title="contracts_Tolk/01_jetton/errors.tolk"
  ...
  >
    ```tolk title="contracts_Tolk/01_jetton/fees-management.tolk"
  ...
  <Accordion
    title="storage.tolk"
  >
    ```tolk title="contracts_Tolk/01_jetton/storage.tolk"
  ...
  <Accordion
    title="messages.tolk"
  >
    ```tolk title="contracts_Tolk/01_jetton/messages.tolk"
  ...
  >
    ```tolk title="contracts_Tolk/01_jetton/jetton-utils.tolk"
    import "storage"
  ...
  >
    ```tolk title="contracts_Tolk/01_jetton/jetton-minter-contract.tolk"
  ...
  >
    ```tolk title="contracts_Tolk/01_jetton/jetton-wallet-contract.tolk"
    import "@stdlib/gas-payments"
    import "errors"
    import "jetton-utils"
    import "messages"
...
Source directory in `tolk-bench`: [`contracts_Tolk/02_nft`](https://github.com/ton-blockchain/tolk-bench/tree/cb9648bdf936f88eb9d773d9058405f74a1e24d9/contracts_Tolk/02_nft)
...
<AccordionGroup>
  <Accordion
    title="errors.tolk"
  >
    ```tolk title="contracts_Tolk/02_nft/errors.tolk"
    // these error codes are quite strange, but they are exactly the same as in FunC implementation
  ...
  <Accordion
    title="fees-management.tolk"
  >
    ```tolk title="contracts_Tolk/02_nft/fees-management.tolk"
  ...
  <Accordion
    title="storage.tolk"
  >
    ```tolk title="contracts_Tolk/02_nft/storage.tolk"
  ...
  <Accordion
    title="messages.tolk"
  >
    ```tolk title="contracts_Tolk/02_nft/messages.tolk"
    import "storage"
  ...
  >
    ```tolk title="contracts_Tolk/02_nft/nft-collection-contract.tolk"
    import "errors"
    import "storage"
    import "messages"
  ...
  >
    ```tolk title="contracts_Tolk/02_nft/nft-item-contract.tolk"
    import "@stdlib/gas-payments"
    import "errors"
    import "storage"
    import "messages"
