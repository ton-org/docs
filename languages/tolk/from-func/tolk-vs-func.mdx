...
1. See [Tolk contract examples](/languages/tolk/examples).
1. Use the [FunC-to-Tolk converter](/languages/tolk/from-func/converter) to migrate existing projects.

## Gas benchmarks

The [tolk-bench repository](https://github.com/ton-blockchain/tolk-bench) compares FunC and Tolk across several TEPs. For embedded jetton and NFT examples from that repository, see [Tolk contract examples](/languages/tolk/examples).
