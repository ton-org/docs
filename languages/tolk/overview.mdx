...
1. [JetBrains IDEs plugin](/contract-dev/ide/jetbrains#tolk) provides syntax highlighting and code navigation. Download from [marketplace](https://plugins.jetbrains.com/plugin/23382-ton) and [install it](/contract-dev/ide/jetbrains#installation).
