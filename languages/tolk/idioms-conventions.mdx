...
<Aside type="tip">
  See [Tolk contract examples](/languages/tolk/examples#jetton) for the embedded basic jetton example extracted from [`tolk-bench`](https://github.com/ton-blockchain/tolk-bench).
</Aside>
