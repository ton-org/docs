...
- `cell` is a [TVM cell type](/tvm/serialization/cells) used to store persistent data in TON Blockchain. Data is organized in a [bag of cells](/tvm/serialization/boc), with each cell containing up to 1023 bits of arbitrary data and up to four references to other cells.
