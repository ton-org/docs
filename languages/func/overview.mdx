...
To compile FunC files to bitcode, you'll need the `func-js` NPM package.
...
<Aside>
  We recommend placing the FunC standard library file in your project root. Download `smartcont_lib.zip` from the [GitHub repository](https://github.com/ton-blockchain/ton/releases/tag/v2025.07), extract it, and copy `stdlib.fc` to your project root.
</Aside>
