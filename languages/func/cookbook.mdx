...
You can use the [`cons`](/languages/func/stdlib#cons) function to add an element at the front of the list.
The [`null?`](/languages/func/built-ins#null%3F) function checks if the provided argument is the `null` value.
