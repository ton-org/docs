...
- [`Cell` in docs](/foundations/cell-serialization/cells)
...
>
  ...
  For more details, see [Random number generation](/contract-dev/random) section.
</Aside>
...
**Note:** In this example, we use `workchain()` to retrieve the workchain ID. You can learn more about the workchain ID in [docs](/foundations/addresses/overview#workchain-id).
...
**Reference:** [`Message layout` in docs](/foundations/messages/overview)
...
- [`Message layout` in docs](/foundations/messages/overview)
...
**Reference:** [`Internal messages` in docs](/foundations/messages/overview)
