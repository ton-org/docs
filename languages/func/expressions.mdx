...
- A [compile-time builtin](/language/func/literals#compile-time-built-ins)
...
The following way of calling `store_uint` (here, [`begin_cell`](/language/func/stdlib#begin-cell) creates a new builder and has type `() -> builder`):
