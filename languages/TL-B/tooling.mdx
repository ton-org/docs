...
TL-B libraries provide serializers and parsers for basic [TL-B types](/language/TL-B/syntax-and-semantics) and can serialize to and deserialize from the corresponding binary format.
