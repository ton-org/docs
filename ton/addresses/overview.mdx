...
External addresses are closely related to [External messages](/ton/messages/overview): ones that originate outside the blockchain or are intended for actors outside it. These messages enable interaction between smart contracts and the external world.
...
- [Internal address formats](/ton/addresses/formats): encoding rules and practical examples.
