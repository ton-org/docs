...
- `anycast`: not currently used in the blockchain and is always replaced with a zero bit. It's designed to implement the shard splitting of global (or large) accounts, which is not implemented at the moment.
