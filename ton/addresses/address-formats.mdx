...
**Nota bene: Uppercase letters (A–F) may be used in address strings instead of their lowercase counterparts (a-f).**
...
- send a **bounceble** message to a **Testnet** address;
- send a **non-bounceble** message to a **Testnet** address;
