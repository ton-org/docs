...
<a name="footnote-33" /> **33**  The original PDF referred to an early version of the Telegram Open Network. We have redirected links **[1.x.x]** to the [**The Open Network**](/ton/ton) PDF and the [**TON Blockchain**](/ton/tblkch) PDF. [Back ↑](#abstract)