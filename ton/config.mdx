...
<Aside>
Configuration values are TL-B typed cells serialized into Bags of Cells (BoC); see [canonical serialization](/ton/cells/boc) and [Bag of Cells](/ton/cells/bag-of-cells).
</Aside>
