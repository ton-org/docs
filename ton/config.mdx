...
This parameter defines the cost of filing complaints about the incorrect operation of validators in the [elector smart contract](/ton/system-contracts).
...
- `validators_elected_for`: The number of seconds the elected set of validators performs their role (one round).
