...
You can view the parameter values in the [current configuration](https://tonviewer.com/config), and the method of writing them into [cells](/tvm/serialization/boc) is outlined in the [block.tlb](https://github.com/ton-blockchain/ton/blob/master/crypto/block/block.tlb) file in [TL-B](/language/TL-B/overview) format.

<Aside>
Configuration values are TL-B typed cells serialized into [Bags of Cells (BoC)](/tvm/serialization/boc).
</Aside>
