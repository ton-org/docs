...
- **[Cells](/tvm/serialization/cells)** – TON’s universal data structure, used to represent every piece of information on-chain, from account states to transactions.
- **[Addresses](/ton/addresses/address-formats)** – The scheme TON uses to uniquely identify accounts and smart contracts across workchains.
...
- **[Blocks](/ton/blocks)** – The structure of TON blocks, which record the results of transactions and link shardchains together.
...
- **[Cells](/ton/cells/bag-of-cells)** – TON’s universal data structure, used to represent every piece of information on-chain, from account states to transactions, in a compact and hash-friendly format.
