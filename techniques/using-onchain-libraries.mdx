...
In that case, you will need to pull the account state and resolve all library cells (in most cases, if the contract is using libraries, the whole code of the contract is the library).
