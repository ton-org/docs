...
ComputeDataSize have the second argument - maximum number of cells to visit. If it is ok to set in in *8192* since it is the [limit for message size](/ton/limits#message-and-transaction-limits).
```tact
...
To extract the size of a contract in test you can use this function
```ts
