...
<div
  className="relative w-full box-border flex flex-col mx-auto px-6 max-w-xl md:max-w-3xl lg:max-w-4xl xl:max-w-5xl"
>
  {/* hero */}
  ...
  >
    ...
    <div
      className="py-16 sm:py-24 lg:py-32 flex flex-col lg:flex-row lg:items-center lg:gap-16 xl:gap-24"
    >
      {/* left */}

      <div
        className="w-full lg:flex-[2] mx-auto lg:mx-0 lg:max-w-2xl"
      >
        <div
        ...
        >
          ...
          >
            ...
            <a
              href="TODO: link to TON Dev channel"
        ...
        >
          <h1
            className="text-balance text-5xl sm:text-7xl font-semibold tracking-tight text-gray-900 dark:text-gray-200"
          >
            Welcome to<br />TON Blockchain<br />documentation
          </h1>

          <p
            className="mt-8 max-w-xl text-pretty text-2xl prose prose-gray dark:prose-invert"
          >
          ...
          >
            ...
            <a
              href="#journeys"
              className="font-semibold text-lg prose-gray dark:prose-invert"
            >
  ...
  <section
    id="navigation"
    tabIndex={-1}
    className="relative mt-16 py-12 sm:py-24 flex flex-col gap-8"
  >
    <div
      className="text-left"
    >
      <h2
        className="text-balance text-3xl sm:text-5xl font-semibold tracking-tight text-gray-900 dark:text-gray-200"
      >
        Quick section navigation
      </h2>

      <p
        className="mt-4 text-pretty text-xl prose prose-gray dark:prose-invert"
      >
  ...
  >
    ...
    >
      <p
        className="mt-4 text-pretty text-lg prose prose-gray dark:prose-invert"
      >
