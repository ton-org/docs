...
- On Ethereum, it appears as _a single atomic transaction_ with multiple contract calls inside it. This transaction has a single hash and is included in one block.
