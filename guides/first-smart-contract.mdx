...
>
  ...
  - [View the complete contract on GitHub](https://github.com/ton-org/ton-docs-examples/blob/main/guidebook/first-smart-contract/Example/contracts/first_contract.tolk)
</Aside>
...
>
  You can find the full working code for this tutorial in our [GitHub repository](https://github.com/ton-org/ton-docs-examples/tree/main/guidebook/first-smart-contract/Example). This includes all contract files, scripts, and wrappers ready to use.
</Aside>
...
- [Tutorial Example Repository](https://github.com/ton-org/ton-docs-examples/tree/main/guidebook/first-smart-contract/Example) - Complete working code from this tutorial

#### **Advanced Topics**

- [Gas Optimization](/patterns/gas) - Reduce transaction costs
- [Security Best Practices](/patterns/security) - Protect your contracts
