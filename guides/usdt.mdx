...
>
  The authentic USDT [Jetton Master](/standard/tokens/jettons/how-it-works#jetton-master) address is:

  `EQCxE6mUtQJKFnGfaROTKOt1lZbDiiX1kCixRv7Nw2Id_sDs`

  **Any token with a different Jetton Master address is NOT the real USDT.** Always verify this address before accepting or purchasing USDT. Scammers can create fake tokens with similar names.
</Aside>
...
![Locating Tether USD in Tokens list](/resources/images/tether.png)
...
<Aside type="tip">
  If you want to suggest users to transfer USDT through your dApp, you can use the [TON Connect](/ecosystem/ton-connect) library. TON Connect will make user's chosen wallet to ask user to confirm the USDT transfer.
</Aside>
