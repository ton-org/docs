...
| ---------- | ------------------- | ------------------------------------------------------ |
| `size`     | 4 bytes (LE)        | Total packet size `N`, excluding this field             |
...
| Cipher   | Key (bytes) | IV (bytes) | Used for                                |
| -------- | ----------- | ---------- | --------------------------------------- |
...
Simplified example of the DH principle:

1. Client generates secret **6** and public **7**. Server generates secret **5** and public **15**.
1. They exchange public numbers.
1. Client computes 7^6 mod 15 = **4**. Server computes 7^5 mod 15 = **7**.
1. They exchange results.
1. Client computes 7^6 mod 15 = **4**. Server computes 4^5 mod 15 = **4**.
1. Shared key = **4**.
