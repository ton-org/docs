...
Below we describe how the reservation action is implemented.
...
Below we outline the reservation flow step by step in order to give a full picture of how the reservation is implemented and how different modes interact with each other.
...
1. Check that `mode` has flag `ReserveMinRemainingBalance`:
