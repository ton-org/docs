...
- and when either
  ...
  - or an action fails in the [action phase](/foundations/phases#action-phase) with the `+16` flag enabled, for example [`SendBounceIfActionFail`](/foundations/messages/modes) or [`ReserveBounceIfActionFail`](/foundations/reserve#modes).
