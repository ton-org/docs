...
Below we describe how the reservation action is implemented. To see examples of when the reservation is used in practice and learn how to solve related problems, visit the [reserve dev.](/contract-dev/reserve) page.
