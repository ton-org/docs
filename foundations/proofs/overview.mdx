...
<Aside>
  It is highly recommended to familiarize yourself with [Exotic cells](/foundations/cell-serialization/merkle) first. This article primarily covers situations where you want to verify a proof in a smart contract. However, the same techniques can be used to validate proofs off-chain.
</Aside>
