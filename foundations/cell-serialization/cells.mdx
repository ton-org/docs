...
| Type id | Description                                      |
| ------- | ------------------------------------------------ |
| `0x01`  | [Pruned branch](foundations/cell-serialization/pruned)        |
| `0x02`  | [Library reference](foundations/cell-serialization/library)   |
| `0x03`  | [Merkle proof](foundations/cell-serialization/merkle)         |
| `0x04`  | [Merkle update](foundations/cell-serialization/merkle-update) |
...
However, the serialization of graphs formed by cells is arranged differently; see [bag of cells](/foundations/cell-serialization/boc) for details.
