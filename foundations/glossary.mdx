...
serialization format for cells. Commonly used in code. [Article](/foundations/cell-serialization/boc).
...
a program connecting various blockchains to transfer tokens and data from one network to another. [Article](/ecosystem/interoperability/oracles/overview).
...
the main network of a blockchain. [Article](/foundations/overview).
