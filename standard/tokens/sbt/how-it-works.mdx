...
- _Prove ownership_: sending proof of SBT ownership to a target contract.
- _Request current owner_: requesting current owner information from SBT.
- _Destroy SBT_: destroying the SBT contract and returning remaining balance.
- _Revoke SBT_: marking the SBT as revoked by authority.
