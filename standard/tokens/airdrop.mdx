...
We must also prevent double-claims. The airdrop deploys a small per-user marker contract that records whether the user has already claimed. This marker blocks any subsequent attempts.
