...
use the `get_wallet_data()` [get method](/guidebook/first-smart-contract.mdx) within the Jetton wallet contract.
...
async function main() {
  ...
  console.log(Stack.readAddress().toString()); // jetton_master_address
