...
Jetton master contracts also receive notifications about the [burning of tokens](/standard/tokens/jettons/burning).
When they receive such a notification, they must adjust the total supply accordingly.

### Jetton wallet

_Jetton wallet_ smart contracts are used to [transfer](/standard/tokens/jettons/transfer), receive, and [burn](/standard/tokens/jettons/burning) jettons. Each jetton wallet contract stores
