...
Or if you are sure about the structure of Jetton wallet's initial persistent storage and know its code, you can also manually create [`StateInit`](/foundations/messages/state-init) of the Jetton wallet and thus calculate its address.
