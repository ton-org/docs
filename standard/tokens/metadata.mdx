...
To parse metadata, first retrieve the NFT data from the blockchain. For details, see [retrieving NFT data](/v3/guidelines/dapps/asset-processing/nft-processing/nfts) in the TON asset processing documentation.
...
Use the following API to parse metadata: [API Metadata](/api-reference/accounts/metadata). It handles most cases within gas limits; in rare cases, parsing may fail.
