...
Use the following API to parse metadata: [API Metadata](/ecosystem/rpc/ton-center-v2/accounts/get-account-metadata). It handles most cases within gas limits; in rare cases, parsing may fail.
