...
Use the following API to parse metadata: [API Metadata](/api-reference/accounts/get-account-metadata?playground=open). It handles most cases within gas limits; in rare cases, parsing may fail.
