...
[Metadata](/standard/tokens/metadata) is split into two parts: the collection stores collection‑wide data, and the item stores item‑specific data (not necessarily the full metadata).
