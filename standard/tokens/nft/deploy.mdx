...
- `.storeUint(1, 32)` — operation code `1` selects "deploy single item" in the [reference collection contract](/standard/tokens/nft/reference#deploy-single-item). TEP-62 does not specify this opcode, so in custom implementations, this can differ.
