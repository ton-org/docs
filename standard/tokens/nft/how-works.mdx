...
In The Open Network (TON), there is a collection smart contract and a separate smart contract for every non-fungible token (NFT) item — each item is its own contract. See [contract sharding](/techniques/contract-sharding).

![NFT overview](/standard/tokens/nft/pictures/nftOverview.jpg)
...
![NFT metadata](/standard/tokens/nft/pictures/nftGetMetadata.jpg)
