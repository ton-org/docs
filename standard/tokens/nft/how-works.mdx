...
There is a collection smart contract and a separate smart contract for every NFT item — each item is its own contract, see more [why](/patterns/contract-sharding).
