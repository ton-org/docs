...
There is a collection smart contract and a separate smart contract for every NFT item — each item is its own contract, see more [why](/contract-dev/contract-sharding).
...
[Playground link for metadata](/ecosystem/api/toncenter/v3/accounts/get-account-metadata?playground=open)
