...
To deploy NFTs compatible with existing TON marketplaces, use contract implementations that follow the NFT standard.
...
- [Getgems NFT contracts](https://github.com/getgems-io/nft-contracts) – production-ready contract templates used by the Getgems marketplace.
