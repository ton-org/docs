...
[Mandatory royalties](/standard/tokens/nft/nft-2.0#mandatory-royalty-distribution) are ecosystem-level fees and are not returned by `royalty_params()`. They must be applied separately.
...
- Added two mandatory royalties: Community fund and Telegram fund

**Initial version**

The first public release of NFT 2.0
