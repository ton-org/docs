...
There [API method](/ecosystem/rpc/toncenter/v3/nfts/get-nft-items?playground=open) that can perform this verification off‑chain, just put addresses of NFT item and NFT collection.
