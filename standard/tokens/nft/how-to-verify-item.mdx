...
There [API method](/ecosystem/rpc/ton-center-v3/nfts/get-nft-items) that can perform this verification off‑chain, just put addresses of NFT item and NFT collection.
