...
There is an [API method](/ecosystem/rpc/toncenter/v3/nfts/get-nft-items?playground=open) that can perform this verification off‑chain with a single request. Just provide the addresses of the NFT item and NFT collection:
