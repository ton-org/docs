...
First, you can use your wallet app with NFTs, just follow the corresponding guides.
Second, you can use your favorite IDE. Below there are two illustrative examples:
...
async function main() {
    const nftItemAddress = Address
        .parse('put your NFT item address');
    const newOwner = Address
        .parse('put new owner address');
