...
|-------------------------|---------------------|-----------------------|---------------------------|-----------------------|------------------------------|
| **Seqno based**         | ✅ Yes               | ✅ Yes                 | ❌ No (query_id based)     | ✅ Yes                 | ✅ Yes                        |
...
| **Support gasless**     | ❌ No                | ✅ Yes                 | ❌ No                      | ❌ No                  | ❌ No                         |
...
- **Query-based processing**: Uses query id and batch id instead of seqno for better transaction submission tracking
