...
| Wallet Version         | Requests | Total Gas | Gas per Msg | Total Fee (TON) | Fee per Msg (TON) | % to best gas (msg) | % to best fee (msg) | Real Time (sec) | Theoretical Time (sec) |
| ---------------------- | -------- | --------- | ----------- | --------------- | ----------------- | ------------------- | ------------------- | --------------- | ---------------------- |
| Preprocessed Wallet V2 | 4        | 6,148     | 6           | 0.263707201     | 0.000263707       | −80.65%             | −50.80%             | 52s             | 16s                    |
...
| Wallet Version         | Requests | Total Gas | Gas per Msg | Total Fee (TON) | Fee per Msg (TON) | % to best gas (msg) | % to best fee (msg) | Real Time (sec) | Theoretical Time (sec) |
| ---------------------- | -------- | --------- | ----------- | --------------- | ----------------- | ------------------- | ------------------- | --------------- | ---------------------- |
| Preprocessed Wallet V2 | 1        | 1,537     | 7           | 0.063206801     | 0.000316034       | −82.05%             | −48.01%             | 13s             | 4s                     |
...
| Wallet Version         | Requests | Total Gas | Gas per Msg | Total Fee (TON) | Fee per Msg (TON) | % to best gas (msg) | % to best fee (msg) | Real Time (sec) | Theoretical Time (sec) |
| ---------------------- | -------- | --------- | ----------- | --------------- | ----------------- | ------------------- | ------------------- | --------------- | ---------------------- |
| Preprocessed Wallet V2 | 4        | 6,148     | 6           | 0.314907201     | 0.000314907       | −99.18%             | −48.01%             | 52s             | 16s                    |
...
| Wallet Version         | Requests | Total Gas | Gas per Msg | Total Fee (TON) | Fee per Msg (TON) | % to best gas (msg) | % to best fee (msg) | Real Time (sec) | Theoretical Time (sec) |
| ---------------------- | -------- | --------- | ----------- | --------------- | ----------------- | ------------------- | ------------------- | --------------- | ---------------------- |
| Preprocessed Wallet V2 | 1        | 1,537     | 384         | 0.0037252       | 0.0009313         | −67.26%             | −19.93%             | 13s             | 4s                     |
...
| Wallet Version         | Requests | Total Gas | Gas per Msg | Total Fee (TON) | Fee per Msg (TON) | % to best gas (msg) | % to best fee (msg) | Real Time (sec) | Theoretical Time (sec) |
| ---------------------- | -------- | --------- | ----------- | --------------- | ----------------- | ------------------- | ------------------- | --------------- | ---------------------- |
| Preprocessed Wallet V2 | 4        | 6,148     | 6           | 0.654107201     | 0.000654107       | −80.65%             | −30.78%             | 52s             | 16s                    |
