...
This article provides only high level wallet V5 contract overview, if you want to learn more about how to use its interfaces or develop extensions, check out [wallet V5 API](/standard/wallets/v5-api) article.
