...
Ton wallets can attach short human-readable notes — commonly called *comments* — to outgoing internal messages. On-chain they are just message bodies with a specific layout that wallets agree to interpret as text.
