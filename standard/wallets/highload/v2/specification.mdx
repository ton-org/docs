...
[TL-B (Type Language - Binary)](/language/TL-B/overview) is a domain-specific language designed to describe data structures in TON. The schemas below define the binary layout of the contract's storage and external messages.
...
1. **Send messages:** Iterate through message dictionary and send each message
