...
<Aside type="note" title="No deployment yet">
...
<Aside type="note" title="Why copy wrappers?">
...
<Aside type="tip" title="Why non-bounceable?">
...
<Aside type="note" title="Automatic deployment">
...
<Aside type="note" title="Maximum actions">
