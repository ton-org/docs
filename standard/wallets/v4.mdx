...
- `subwallet_id`: 32-bit long subwallet\_id. This is a number that allows you to create multiple wallets with the same private key but different addresses.
...
self_destory#64737472 = InternalMsgBody;
```
...
Next, let's explore kinds of messages:
