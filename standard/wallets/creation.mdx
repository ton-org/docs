...
Create a wallet programmatically, match it with wallets created from a mnemonic in user applications (e.g., TonKeeper, TonWallet), and deploy it if the state is uninit.
