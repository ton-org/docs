...
- Use component `width`/`height` props for predictable layout when needed; avoid arbitrary inline styling. (Why: predictable dimensions prevent jank and maintain consistency.)
