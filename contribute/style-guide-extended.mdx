...
- Good advanced notice (top of page):
  Audience: Advanced. Assumes understanding of WorkChain/ShardChain and TVM opcodes. Links: [WorkChain](/ton/shards/), [TVM opcodes](/tvm/instructions/).
...
> Start the node with `--threads` (see [validator flags → `--threads`](/ecosystem/node/overview#validator)) to increase parallelism.
