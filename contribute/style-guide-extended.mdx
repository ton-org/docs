...
- You **MUST NOT** use bold to style tokens, flags, filenames, or UI/log messages; use code font for tokens and quotation marks for literal UI/log strings. (Why: consistent token styling keeps examples copy‑pasteable and searchable.) \[HIGH]
