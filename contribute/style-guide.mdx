...
* Use American English spelling (for example, color instead of colour). American English is more common.
...
* Start each page with a single H1 that matches the title.
...
* Use plain American English; avoid idioms and culture‑specific references.
