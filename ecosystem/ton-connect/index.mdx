...
Go through the step-by-step guide with a tech that suits you most.
...
<Columns cols={3}>
  <Card
    title="QA Guide"
    icon="book"
    href="/integrate/ported/qa-guide">
  </Card>
  <Card
    title="Native or web wallets"
    icon="book"
    href="/integrate/ported/native-web">
  </Card>
  <Card
    title="In-app or browser extension wallets"
    icon="book"
    href="/integrate/ported/browser-extension">
  </Card>
</Columns>
