...
<img className="block dark:hidden" src="/resources/images/ton-connect/basic-schema.svg" alt="Basic communication schema of TON Connect" />

<img className="hidden dark:block" src="/resources/images/ton-connect/basic-schema-dark.svg" alt="Basic communication schema of TON Connect" />
...
<Columns cols={2}>
  <Card title="Demo TON dApp with React" icon="link" href="https://ton-connect.github.io/demo-dapp-with-react-ui/" arrow="true" />

  <Card title="Demo TON dApp GitHub repository" icon="github" arrow="true" href="https://github.com/ton-connect/demo-dapp-with-react-ui" />
</Columns>

Proceed with integration and usage recipes.

<Columns cols={2}>
  <Card icon="flask" title="How to integrate a dApp with TON" href="/guidebook/dapp" />

  <Card icon="wrench" title="Common usage examples" href="/guidebook/dapp#usage" />
</Columns>

Skim the related reference pages.

<Columns cols={2}>
  <Card title="App manifest" icon="book" href="/ecosystem/ton-connect/manifest#app-manifest" />

  <Card title="@tonconnect/sdk" arrow="true" href="https://ton-connect.github.io/sdk/modules/_tonconnect_sdk.html" />

  <Card title="@tonconnect/ui" arrow="true" href="https://ton-connect.github.io/sdk/modules/_tonconnect_ui.html" />

  <Card title="@tonconnect/ui-react" arrow="true" href="https://ton-connect.github.io/sdk/modules/_tonconnect_ui-react.html" />
</Columns>
...
<Card icon="flask" title="How to make a wallet on TON" href="/guidebook/wallet" />

Or skim the related reference pages.

<Columns cols={2}>
  <Card title="Wallet manifest" icon="book" href="/ecosystem/ton-connect/manifest#wallet-manifest" />

  <Card title="WalletKit reference" icon="book" href="/ecosystem/ton-connect/walletkit" />
...
<Columns cols={3}>
  <Card title="QA Guide" icon="book" href="/ecosystem/ton-connect/walletkit/qa-guide" />

  <Card title="Native or web wallets" icon="book" href="/ecosystem/ton-connect/walletkit/native-web" />

  <Card title="In-app or browser extension wallets" icon="book" href="/ecosystem/ton-connect/walletkit/browser-extension" />
</Columns>
...
<Columns cols={1}>
  <Card icon="flask" title="How to integrate TON into a Centralized Exchange (CEX)" href="/guidebook/cex" />
</Columns>
...
<Columns cols={1}>
  <Card icon="scroll" title="Index of curated community tutorials" href="/guidebook/more" />
</Columns>
...
<Columns cols={2}>
  <Card icon="telegram" title="Telegram folder with many developer chats" arrow="true" href="https://t.me/addlist/1r5Vcb8eljk5Yzcy" />

  <Card icon="person" title="List of skilled professionals and agencies" arrow="true" href="https://ton.org/en/talents" />
</Columns>
