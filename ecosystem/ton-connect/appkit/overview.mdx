---
title: "AppKit: TON Connect integration layer for decentralized applications (dApps)"
...
- DeFi integrations: make on-chain Toncoin and jetton swaps with the [Omniston](https://ston.fi/omniston).
