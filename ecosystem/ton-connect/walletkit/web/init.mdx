...
<Columns cols={2}>
  <Card title="Demo wallet, deployed" icon="link" horizontal="true" href="https://walletkit-demo-wallet.vercel.app">
    
  </Card>
  <Card title="Demo wallet, GitHub" icon="github" horizontal="true" href="https://github.com/ton-connect/kit/tree/main/apps/demo-wallet">
...
<Columns cols={2}>
  <Card title="Manage TON wallets" icon="wallet" horizontal="true" href="/ecosystem/ton-connect/walletkit/web/wallets">
