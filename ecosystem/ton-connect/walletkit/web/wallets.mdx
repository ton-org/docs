...
{/* You may load or create it using one of these options:
...
2. Then, select a wallet adapter — it's an implementation of the `WalletInterface` type for a particular TON wallet contract. Currently, WalletKit provides two: `WalletV5R1Adapter` (recommended) and `WalletV4R2Adapter`.
