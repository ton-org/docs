...
Liteserver provides an [ADNL](/foundations/network) API to fetch specific blocks, accounts, and transactions instead of synchronizing a full state. It is also useful to run HTTP API, which provide endpoints to interact with liteserver without a need to connect over ADNL.
...
<Aside type="note">There is a [reference](/ecosystem/node/mytonctrl/validator) for validator-related commands in mytonctrl.</Aside>
...
<Aside type="note">There is a [reference](/ecosystem/node/mytonctrl/collator) for collator-related commands in mytonctrl.</Aside>
...
<Aside type="note">There is a [reference](/ecosystem/node/mytonctrl/pools) for nominator-related commands in mytonctrl.</Aside>

### Liquid staking

<Aside type="note">There is a [reference](/ecosystem/node/mytonctrl/liquid_staking) for liquid staking related commands in mytonctrl.</Aside>
