...
>
 Use a cold wallet (e.g., Ledger) for the owner wallet and store its seed phrase securely to keep funds safe. If access to the owner wallet is lost, the funds cannot be recovered.
</Aside>
