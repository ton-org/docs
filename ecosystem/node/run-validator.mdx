...
<Aside type="tip">
  Set up [alert bot](/ecosystem/node/mytonctrl/integrating-with-prometheus) to receive a notification when the node is synchronized.
</Aside>
...
Set up alerting in MyTonCtrl to get a notification of critical issues with the validator. For more information, see [MyTonCtrl private alerting bot](/ecosystem/node/mytonctrl/alerting) or check [MyTonCtrl public alerting bot](https://t.me/validators).

### 5.4 Set up monitoring

Set up monitoring dashboards for RAM, disk, network, CPU usage, and other metrics. See also [MyTonCtrl prometheus export](/ecosystem/node/mytonctrl/integrating-with-prometheus). For technical assistance, please contact [@mytonctrl\_help\_bot](https://t.me/mytonctrl_help_bot).
