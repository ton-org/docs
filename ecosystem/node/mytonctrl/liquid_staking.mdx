...
- Uses the validator's election cycle length from config 15 to compute how many rounds fit into a year, and then scales the provided (or configured `max_interest_percent`) rate.
