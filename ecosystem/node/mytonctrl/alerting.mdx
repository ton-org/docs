...
**Behavior**
- Lists every alert key (`low_wallet_balance`, `db_usage_80`, `out_of_sync`) along with the enabled flag and the UNIX timestamp when it was last sent.
...
**Behavior**
- Accepts any alert key defined in the alert module (`low_efficiency`, `service_down`, `validator_slashed`).
