...
1. Visit [@getmyid\_bot](https://t.me/getmyid_bot) and press the **Start** button. The bot will reply with a chat ID; use this ID to receive messages from the bot.

To receive messages in a group, add [@getmyid\_bot](https://t.me/getmyid_bot) to the group, and it will provide the chat ID of this group.
