...
- Fetches the offer, runs lite-client commands to dump the proposed config, and shows a `diff` between the current value and the proposal. Requires the shell `diff` utility.
