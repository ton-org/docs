...
MyTonCtrl wraps the TON validator toolchain (`lite-client`, `validator-engine-console`, installer utilities) into a single console. The steps below are grouped by operator goal so you can jump straight to the workflow you need.
