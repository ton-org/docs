...
**You need:** a fully synchronized node, validator mode not active elsewhere, and at least the current minimum stake (≈300k TON; check [tonscan.com/validation](https://tonscan.com/validation) for live numbers).
...
- Contact validator support via [@mytonctrl_help_bot](https://t.me/mytonctrl_help_bot); regular node operators can use [@mytonctrl_help](https://t.me/mytonctrl_help).
- Report infrastructure issues to [@ton_node_help](https://t.me/ton_node_help).
