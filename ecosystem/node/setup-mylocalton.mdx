...
- Graduate to production setups with [Setting up a node using MyTonCtrl](/ecosystem/node/setup-mytonctrl).
- Explore node roles and responsibilities in the [node overview](/ecosystem/node/overview).
