...
Set up monitoring dashboards for RAM, disk, network, CPU usage, and other metrics. See also [MyTonCtrl prometheus export](/ecosystem/nodes/cpp/integrating-with-prometheus). For technical assistance, please contact [@mytonctrl\_help\_bot](https://t.me/mytonctrl_help_bot).
