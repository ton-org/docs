...
- Access to the local chart at `./helm/ton-rust-node` by cloning the [`ton-rust-node` repository](https://github.com/RSquad/ton-rust-node/tree/e8bd0451b326099146a90a913beedaebd952fa56/helm/ton-rust-node).
...
To deploy a validator, use this page for base node deployment and keep liteserver and JSON-RPC ports disabled. For validator election and operations workflow, use the [validator guide (`nodectl`)](https://github.com/RSquad/ton-rust-node/blob/e8bd0451b326099146a90a913beedaebd952fa56/helm/nodectl/README.md).
