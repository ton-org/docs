...
1. When the bundled config becomes outdated. The official config may change over time, for example, updated DHT nodes or init blocks. Fetching a fresh copy periodically is recommended.
