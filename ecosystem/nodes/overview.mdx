...
TON Rust node is an alternative TON full node implementation written in Rust for production-grade, cloud-native infrastructure. It is protocol-compatible with TON and follows a different operational approach than traditional single-instance deployments.
...
- cluster-oriented node lifecycle management;
- enterprise-oriented key management integration; [HashiCorp Vault](https://www.hashicorp.com/en/products/vault).
...
- Institutional operators that need stronger operational control and transparent reporting flows.
...
Source: [TON Rust Node resource recommendations](https://github.com/RSquad/ton-rust-node/blob/master/helm/ton-rust-node/docs/resources.md).
...
1. To have a stable connection, you can set up your own full or archive node with a liteserver mode and ton-http-api enabled using [MyTonCtrl](/ecosystem/nodes/cpp/setup-mytonctrl).
