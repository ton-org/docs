...
<Aside
  ...
  title="Stake requirements"
>
  Track the actual minimum stakes at [tonscan.org/validators](https://tonscan.org/validators). The current minimum is about 750,000 TON, recommended minimum stake is 1M TON.
</Aside>
...
<Aside
  type="caution"
>
  Nominator pools is deprecated and is not recommended to use.
</Aside>
