...
The [liquid staking contract](/ecosystem/staking/liquid_staking) enables staking services to issue liquid staking tokens (LSTs) that represent the underlying staking position. LSTs can be used in DeFi while the underlying TON earns rewards.
...
Third-party staking providers who use liqufidity pool for staking:
