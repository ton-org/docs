...
**Documentation**: See [MyTonCtrl validator documentation](/ecosystem/nodes/cpp/setup-mytonctrl) for detailed setup and management instructions.
...
- [MyTonCtrl nominator pools](/ecosystem/nodes/cpp/mytonctrl/pools#nominator-pool-operations-nominator-pool-mode) — standard pools with multiple nominators
...
- [MyTonCtrl single nominator pools](/ecosystem/nodes/cpp/mytonctrl/pools#single-nominator-pool-operations-single-nominator-mode)
