...
1. Find a suitable pool on [tonvalidators.org](https://tonvalidators.org/) — check pool parameters, validator commission, and minimum stake requirements
...
- Use [Toncenter Nominator Pools API](https://toncenter.com/api/smc-index/) to calculate nominator rewards for each round of validation
...
- [Nominator pool github repository](https://github.com/ton-blockchain/nominator-pool)
- [Nominator pool specification](https://docs.ton.org/v3/documentation/smart-contracts/contracts-specs/nominator-pool)
- [Nominator pools guide](/ecosystem/staking/nominators)
- [TON Nominator Pools](https://tonvalidators.org/)
...
- For such cases, API is not yet available from Toncenter, similar to [nominator pools API](/ecosystem/api/toncenter/smc-index/get-nominator-bookings-method)

**Documentation:**

- [Single nominator pool specification](https://docs.ton.org/v3/documentation/smart-contracts/contracts-specs/single-nominator-pool/)
- [Single nominator pools guide](/ecosystem/staking/single-nominator)
