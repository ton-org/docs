...
- **HTTP** libraries connect through HTTP APIs to read and write to blockchain. HTTP servers mostly just relay these requests to ADNL network.
- **ADNL** libraries connect to [liteserver](/pending/participate/nodes/liteserver-node).
...
| First connection takes time for data synchronization | No   | Yes  |
