...
Rate limits apply to all API keys in total separately for every TON network (mainnet/testnet).
For example, if you have Plus plan you can create three API keys for the mainnet and the total limit for these three keys will be 25 requests per second.
