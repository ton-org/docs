...
The examples below use the testnet endpoint. Replace the host with `toncenter.com` for mainnet. `<API_KEY>` is the key obtained from the [TON Center bot](https://t.me/toncenter).
