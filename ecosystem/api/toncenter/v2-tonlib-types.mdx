...
1. Extended types, which are prefixed with `ext.`, are added by TON Center to provide parsed, developer-friendly representations not available in the base tonlib schema.
