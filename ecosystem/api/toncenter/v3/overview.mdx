...
| **Multisig** | [`GET /multisig/wallets`](/ecosystem/api/toncenter/v3/multisig/get-multisigs) | Get Multisigs |
...
| **Legacy (v2)** | [`GET /addressInformation`](/ecosystem/api/toncenter/v3/legacy-v2-compatible/get-address-information) | Get Address Information |
| **Legacy (v2)** | [`POST /estimateFee`](/ecosystem/api/toncenter/v3/legacy-v2-compatible/estimate-fee) | Estimate Fee |
| **Legacy (v2)** | [`POST /message`](/ecosystem/api/toncenter/v3/legacy-v2-compatible/send-message) | Send Message |
| **Legacy (v2)** | [`POST /runGetMethod`](/ecosystem/api/toncenter/v3/legacy-v2-compatible/run-get-method) | Run Get-Method |
| **Legacy (v2)** | [`GET /walletInformation`](/ecosystem/api/toncenter/v3/legacy-v2-compatible/get-wallet-information) | Get Wallet Information |
