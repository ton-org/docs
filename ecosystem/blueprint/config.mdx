...
| [`network`](/ecosystem/blueprint/config#custom-network)               | `'mainnet' \| 'testnet' \| CustomNetwork` |                                          –                                          | Specifies the target network for deployment or interaction.                     |
...
| [`recursiveWrappers`](/ecosystem/blueprint/config#recursive-wrappers) |                 `boolean`                 |                                       `false`                                       | If `true`, searches `wrappers/` or `compilables/` recursively for contracts.    |
| [`manifestUrl`](/ecosystem/blueprint/config#ton-connect-manifest)     |                  `string`                 | `https://raw.githubusercontent.com/ton-org/blueprint/main/tonconnect/manifest.json` | Overrides the default TON Connect manifest URL.                                 |
