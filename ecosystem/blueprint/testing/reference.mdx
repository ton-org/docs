...
Filters transactions array to only include transactions matching the specified pattern.
...
**Returns:** promise resolving to array of executed transactions up to and including the match
