...
- [Testing guidelines](/ecosystem/blueprint/testing/styleguide) — best practices and patterns
...
Test the treasury wallet for sending transactions and managing test funds. Treasury is created by `blockchain.treasury()` and provides a convenient wallet interface for testing.
...
A failed get method execution result from the emote API.
...
Emitted blockchain events during transaction execution.
...
**Returns:** promise resolving to an array of executed transactions up to and including the match
