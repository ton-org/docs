...
TODO: Fix the link (link should directly lead to test section of the article)
To test contracts, follow the [Smart contract testing](/ecosystem/blueprint/test).

## Deployment

TODO: Fix the link (link should directly lead to deploying section of the article)
