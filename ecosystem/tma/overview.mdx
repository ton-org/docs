...
<Columns cols={3}>
  <Card title="Create Mini App CLI" icon="terminal" href="/ecosystem/tma/create-mini-app" />
  <Card title="Telegram UI Kit" icon="palette" href="/ecosystem/tma/telegram-ui/overview" />
  <Card title="Analytics" icon="chart-simple" href="/ecosystem/tma/analytics/analytics" />
</Columns>
