...
Prerequisite versions for Node.js and React are not stated in the source and may be inaccurate.
...
Recommended for a direct integration path.
...
| `variant`               | `"long"` \| `"short"`       | `"long"`          | Button text variant: "Pay with TON Pay" for long or "TON Pay" for short.                                        |
...
| `bgColor`               | `string`                    | `"#0098EA"`       | Background color in hex or CSS gradient.                                                                        |
| `textColor`             | `string`                    | `"#FFFFFF"`       | Text and icon color in hex.                                                                                     |
...
See [Option 1: use `useTonPay`](/ecosystem/ton-pay/ui-integration/button-react#option-1:-use-usetonpay-hook) for a complete example.
...
See [Option 1: use `useTonPay`](/ecosystem/ton-pay/ui-integration/button-react#option-1:-use-usetonpay-hook-recommended) for a complete example.
