...
<Steps>
  ...
  >
    ...
    - **Local copy**
      ...
      After npm install, copy `node_modules/@ton-pay/ui/dist/ton-pay-embed.js` to a public assets folder. For example, use your site's `public/` directory.
