...
<Aside type="tip">
  The TON Pay API key is optional, but providing it enables transaction visibility in [the TON Pay Merchant Dashboard](https://pay.ton.org/dashboard/login), webhook notifications, and wallet management features.
</Aside>
...
The TON Pay API key is optional but enables essential merchant features including transaction visibility in the dashboard, webhook notifications, and centralized wallet management in [the TON Pay Merchant Dashboard](https://pay.ton.org/dashboard/login).
