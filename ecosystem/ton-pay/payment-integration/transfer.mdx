...
<Aside>
  The API key is optional but recommended. It enables transaction visibility in the [TON Pay Merchant Dashboard](https://tonpay.tech/dashboard), webhook notifications, and wallet management features.
</Aside>
...
- [Testnet TON Explorer](https://testnet.tonviewer.com/)
