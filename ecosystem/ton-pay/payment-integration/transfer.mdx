...
The TON Pay API key is optional but recommended for production use. It enables merchant features such as transaction tracking, webhook notifications, and centralized wallet management.

### Obtaining an API key

<Steps>
    <Step title="Open the Merchant Dashboard">
        Go to [`tonpay.tech/dashboard`](https://tonpay.tech/dashboard) and sign in to the merchant account.
    </Step>
    ...
    <Step title="Generate or copy an API key">
