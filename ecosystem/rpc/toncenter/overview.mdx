...
TON Center serves as a public gateway to the TON network. It implements two types APIs, **v2** and **v3**, that correspond to the non-indexed and indexed access layers.
...
is needed for web-based access. v2 provides this bridge by using [`tonlib`](https://github.com/ton-blockchain/ton/tree/master/tonlib/tonlib)
to query data from liteservers and exposes it
through a standard REST interface. v3 extends this model by reading raw data from a node’s 
...
- [v2](https://github.com/toncenter/ton-http-api) 
- [v3](https://github.com/toncenter/ton-indexer)
