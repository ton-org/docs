...
For example, on the [DeDust](https://dedust.io) DEX it is possible to retrieve pool information on-chain using an internal message with following [TL-B](/language/TL-B/overview) schema:
