...
You can get free test coins from [@testgiver_ton_bot](https://t.me/testgiver_ton_bot). Once you open the bot, paste your Testnet wallet address from TonDevWallet. The bot will send 2 TON to your address, and you can only request once per hour.
