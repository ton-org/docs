...
- Battery feature which allows users to make transactions without holding TON for gas fees
- W5 wallet standard implementation for lower transaction costs
- Built-in dApp browser for in-wallet web3 application access
- Supports jettons (tokens) and NFTs for asset management
