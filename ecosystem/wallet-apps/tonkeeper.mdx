...
- **W5 wallet implementation:** supports W5 (Wallet version 5), the latest wallet smart contract standard for the TON blockchain
- **Built-in dApp browser:** provides access to decentralized applications (dApps) directly within the wallet
- **Multi-asset support:** supports digital assets including TON coins, jettons (fungible tokens like USDT, NOT), and NFTs (non-fungible tokens)
