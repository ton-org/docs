...
<img src="/resources/images/tonkeeper/tonkeeper-theme.jpg" alt="tonkeeper" />

## Key features

- Integrates with dApps through the TON Connect protocol, allowing users to securely connect their wallet to web-based applications
...
<img src="/resources/images/tonkeeper/backup.png" height="200" alt="Backup recovery phrase" />
...
<img src="/resources/images/tonkeeper/add-wallet.png" height="200" alt="Add wallet menu" />

3. Enter your saved 24-word mnemonic and click **Continue**. This will create your testnet wallet account.  

<img src="/resources/images/tonkeeper/testnet-account.jpeg" alt="Add testnet account" />
...
To see your activity on the blockchain, insert your address into the search bar of the explorer [Tonviewer](https://tonviewer.com/).

<img src="/resources/images/tonkeeper/nonexist.png" alt="Nonexist state in explorer" />

You can see that the address shows as *nonexist*.
...
4. Review the transaction details, including the deployment fee
...
If you hold [jettons](mint-your-first-token) in your wallet, you can send them to another person.

**Note:** You need at least 0.1 TON to cover transaction fees.
...
**Warning:** Always double-check all the transaction information. Once the transaction is complete, you cannot undo it.
