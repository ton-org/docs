...
1. Open [@testgiver\_ton\_bot](https://t.me/testgiver_ton_bot) in Telegram
1. Start the bot by sending the `/start` command
1. Tap the **Get 2 TON in testnet** button (or send the `/get` command)
1. Complete the captcha that appears
1. Provide your wallet address when prompted
1. The bot will send 2 testnet TON to your address
