...
1. Open [@testgiver\_ton\_bot](https://t.me/testgiver_ton_bot) in your browser. You'll see a prompt asking if you want to open Telegram. Click **Open Telegram** or **START BOT**.
...
After requesting tokens, refresh your wallet to see the updated balance or verify the transaction using the [Tonviewer Testnet explorer](https://testnet.tonviewer.com/).

1. Open [Tonviewer Testnet](https://testnet.tonviewer.com/) and paste your wallet address in the search bar and Click **Find**.
