...
The TON testnet faucet is a Telegram bot that dispenses free test TON tokens.
...
You can interact with the bot at any time using the `/menu` command to view options, or send `/get` to quickly request more tokens.
