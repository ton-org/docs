...
- **ETH-TON Bridge** ([Config Parameter 71](/ton/config#param-71-73%3A-outbound-bridges))
- **BNB-TON Bridge** ([Config Parameter 72](/ton/config#param-71-73%3A-outbound-bridges))
- **Polygon-TON Bridge** ([Config Parameter 73](/ton/config#param-71-73%3A-outbound-bridges))

#### Inbound Bridges (Config parameters 79, 81-82)

These bridges wrap tokens from other networks into TON:

- **ETH-TON Bridge** ([Config Parameter 79](/ton/config#param-79%2C-81-and-82%3A-inbound-bridges))
- **BNB-TON Bridge** ([Config Parameter 81](/ton/config#param-79%2C-81-and-82%3A-inbound-bridges))
- **Polygon-TON Bridge** ([Config Parameter 82](/ton/config#param-79%2C-81-and-82%3A-inbound-bridges))

You can read more about these bridge configuration parameters on the [TON Config page](/ton/config).
