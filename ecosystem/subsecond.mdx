...
Together with consensus update, there is a Streaming API v2 from TON Center and TON API to receive transaction status updates with 30–100ms latency.
...
- Data layer: [TON Center v3][toncenter] or TonAPI.
...
For frontend applications, not a raw indexer, [AppKit][appkit] provides ready-to-use components. It handles out of the box:
...
- [TON Center API overview and endpoints][toncenter]
