...
<Tip>
Since TMAs are web pages and use JavaScript, you need to choose a [JS/TS-based SDK](/guidelines/dapps/apis-sdks/sdk#typescript--javascript).
</Tip>
...
- [Step-by-step guide](https://docs.ton.org/v3/guidelines/dapps/tma/tutorials/step-by-step-guide)
- [See examples](https://docs.ton.org/v3/guidelines/dapps/tma/tutorials/app-examples)
...
- [Discover TON Connect](/ton-connect-overview)
