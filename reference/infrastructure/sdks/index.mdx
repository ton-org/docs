...
Navigate to your preferred programming language using the right sidebar.
...
2. ADNL connection - Connects to a [liteserver](/guidelines/nodes/running-nodes/liteserver-node). While it may be inaccessible at times, it cannot provide false data due to built-in validation.
...
|[tonkite/adnl](https://github.com/tonkite/adnl)|[ADNL](/documentation/network/protocols/adnl/adnl-tcp) natively / via WebSocket| ADNL TypeScript implementation. |
|[tonutils](https://github.com/thekiba/tonutils)|Native [ADNL](/documentation/network/protocols/adnl/adnl-tcp)| TypeScript-based interface for TON application development. Due to native ADNL dependency, it cannot be used in browsers.|
