---
title: Account and smart contract addresses
---

import { Aside } from '/snippets/aside.jsx';

> THIS PAGE IN TON DOCS: https://docs.ton.org/v3/concepts/dive-into-ton/ton-blockchain/smart-contract-addresses
...
A TON address uniquely identifies a contract in the blockchain, indicating its workchain and original state hash. [Two standard formats](/documentation/smart-contracts/addresses#raw-and-user-friendly-addresses) are used: **raw** (workchain and HEX-encoded hash separated by the ":" character) and **user-friendly** (base64-encoded with certain flags).
...
For more details, refer to the refhandling guide in the [Smart contracts addresses documentation](/documentation/smart-contracts/addresses) section.

## See also

- [Explorers in TON](/concepts/dive-into-ton/ton-ecosystem/explorers-in-ton)
- [Smart contracts addresses documentation](/documentation/smart-contracts/addresses)
