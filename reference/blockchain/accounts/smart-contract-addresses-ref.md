---
title: Smart contract addresses (reference)
hidden: false
---

import { Aside } from '/snippets/aside.jsx';

> THIS PAGE IN TON DOCS: https://docs.ton.org/v3/documentation/smart-contracts/addresses
...
On TON, smart contracts are built using the [Actor model](/concepts/dive-into-ton/ton-blockchain/blockchain-of-blockchains#single-actor). In fact, actors on TON are technically represented as smart contracts. This means that even your wallet is a simple actor (and a smart contract).
...
[As we've seen before](/concepts/dive-into-ton/ton-blockchain/blockchain-of-blockchains#workchain-blockchain-with-your-own-rules), it is possible to create as many as `2^32` workchains operating on TON Blockchain. We also noted how 32-bit prefix smart contract addresses identify and are linked to smart contract addresses within different workchains. This allows smart contracts to send and receive messages to and from different workchains on TON Blockchain.
...
To derive the contract's address, you calculate the hash of the **(Initial code, Initial state)** pair. We won’t explore how the [TVM](/documentation/tvm/tvm-overview) works at this time, but it is important to understand that account IDs on TON follow this formula:
...
Feel free to read more on this topic in our documentation to gain a better understanding of [non-bounceable messages](/documentation/smart-contracts/message-management/non-bounceable-messages).
...
It's also possible to make use of similar mechanisms using [SDKs](/guidelines/dapps/apis-sdks/sdk).

### Address examples

Learn more examples on TON Addresses in the [TON cookbook](/guidelines/dapps/cookbook#working-with-contracts-addresses).
