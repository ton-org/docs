...
<Aside type="note">
  The tool attempts to recognize common cell patterns. Since BoC represents raw binary data, some cells may not be fully recognizable or may be parsed incorrectly.
</Aside>
