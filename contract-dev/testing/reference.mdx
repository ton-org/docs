...
**Returns:** [`StateInit`](/foundations/messages/state-init) for contract deployment
...
- `stateInit` — optional [`StateInit`](/foundations/messages/state-init) for contract deployment
