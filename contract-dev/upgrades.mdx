...
This pattern is used in [vanity](/contract-dev/vanity) contracts and when protocols need to upgrade while preserving existing contracts, such as DEXs where liquidity is critical.
