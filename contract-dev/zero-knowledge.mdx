...
For FunC and Tolk, the TypeScript wrapper must be copied manually:
...
These commands copy a TypeScript wrapper file that provides type-safe methods to interact with the verifier contract.
