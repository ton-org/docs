...
The extension would be fetched and installed in your editor. You might need to restart it for changes to take effect.
...
VSIX file: [link](https://github.com/ton-blockchain/ton-language-server/releases/latest)
...
The extension would be installed in your editor. You might need to restart it for changes to take effect.
...
<Aside>
  ...
  codium --install-extensions path/to/extension.vsix

  # Other VSCodium-based editors have similar commands
  ```
</Aside>

See also: [Installing an extension from a VSIX](https://code.visualstudio.com/docs/configure/extensions/extension-marketplace#_install-from-a-vsix)

## Features and language support

Extension provides comprehensive support for TON Blockchain language and technologies in VSCode and VSCode-based editors: from syntax highlighting to on-the-fly inspections, toolchain management, and more.
...
- Build, test, and debug [Blueprint](#blueprint)-based projects
...
- [Sandbox](#sandbox) — Local TON emulator with rich debugging capabilities
...
See the [Sandbox wiki page](https://github.com/ton-blockchain/ton-language-server/wiki/Sandbox:-1.-Overview) for details.
