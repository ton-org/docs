...
- The method `sendDeploy` sends the first message with [`stateInit`](/foundations/messages/state-init), which triggers deployment. In practice, this can be an empty message with some TON coins attached.
