...
<Aside
  type="caution"
>
  Due to the [TON architecture](/from-ethereum#on-chain-get-methods), getters cannot be called from other contracts. Inter-contract communication uses **messages** only.
</Aside>
