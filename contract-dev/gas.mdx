...
When a contract system’s correctness depends on successful execution of the remaining transaction trace, it must guarantee that an incoming message carries enough attached toncoins to cover all fees. This article describes how to compute those fees.
