...
> THIS PAGE IN TON DOCS: https://docs.ton.org/v3/concepts/dive-into-ton/ton-ecosystem/wallet-apps

## Overview

This article describes wallets from the development perspective. The end goal is to create wallet applications that support TON mass adoption.

See the [ton.org/wallets](https://ton.org/wallets) catalog for more wallet apps.
...
- [Wallet contracts](/documentation/smart-contracts/contracts-specs/wallet-contracts/)
