...
<Columns cols={2}>
  <Card title="Fift and TVM assembly" href="/language/fift/fift-and-tvm-assembly" />

  <Card title="Deep dive into Fift" href="/language/fift/deep-dive" />

  <Card title="Simple multi-signature wallet" href="/language/fift/multisig" />
...
<Columns cols={2}>
  <Card title="Fift language specification, web version" href="/language/fift/whitepaper">
...
<Columns cols={2}>
  ...
  <Card title="Other examples" href="/techniques/examples" />
</Columns>
