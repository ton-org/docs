...
<Aside>
  ...
  The official language of TON Blockchain is [Tolk](/language/tolk), and all other languages are deemed legacy. That said, you can still use them and contribute to their development.
...
<Columns cols={3}>
  <Card title="Try it online!" arrow="true" href="https://ide.ton.org/"/>
  <Card title="Tact documentation" arrow="true" href="https://docs.tact-lang.org/"/>
  <Card title="Awesome Tact" arrow="true" href="https://github.com/tact-lang/awesome-tact"/>
</Columns>
