...
In the first example, `not-version >2.1.3` matches any compiler version that is *not* bigger than _2.1.3_, like _2.1.2_, _2.0.5_ and even _2.1.3_ itself. 

In the second example, `not-version ^3.4` matches any compiler version that does *not* match _^3.4_, like _3.3.1_, _4.4.0_, and _3.3.9_ 
