...
Example: send a payment in FunC.
...
Developers can use its bitcode, which is structured as a [tree of cells](/ton/cells/boc) like all data in the TON Blockchain, to create smart contracts or run it on a local instance of the TVM.

### Compile with JavaScript (JS)

Using the Blueprint framework is a convenient way to begin developing and compiling smart contracts. Read more in the [Blueprint](/ecosystem/blueprint/overview) section.

The following command installs all JavaScript (JS) dependencies and creates a template project in the current working directory:
...
<Columns cols={3}>
  ...
  <Card
    title="TON Blockchain course (Chinese)"
    href="https://stepik.org/course/201638/promo"
    arrow
  />

  <Card
    title="TON Blockchain course (Russian)"
...
The best place to start is [Your first smart contract](/guidebook/first-smart-contract).
...
| :---------------- | :-------------------------------------------------------- | :---------------------------------------------------------------------- |
| TSC #5 (Dec 2023) | [Tasks](https://github.com/ton-community/tsc5/)           | N/A                                                                     |
| TSC #4 (Sep 2023) | [Tasks](https://github.com/ton-community/tsc4/)           | [Solutions](/techniques/examples)                                       |
...
See [Smart contract examples](/techniques/examples) to find various standard smart contracts, such as wallets, electors that manage validation on TON, and multi-signature wallets. These can serve as helpful learning references.
