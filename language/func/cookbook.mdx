...
We can use the [cons](/language/func/stdlib#cons) function to add an element to determine if a lisp-style list is empty. For example, adding 100 to the list ensures it is not empty.
...
**Note:**
The contract state can be determined as empty by verifying whether the [cell is empty](/language/func/cookbook#how-to-determine-if-a-cell-is-empty).
...
- The [message](/language/func/cookbook#how-to-build-an-internal-message-cell) is constructed with the body added separately.
...
**Reference:** [`Modifying methods` in docs](/language/func/statements#modifying-methods)
