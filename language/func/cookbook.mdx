...
- In this example, we use the literal `a` to obtain an address. More details on string literals can be found in the [documentation](/language/func/literals#string-literals).
- The example uses [`mode 3`](/ton/messages/internal-messages), which ensures the contract deducts the specified amount while covering the transaction fee from the contract balance and ignoring errors.
...
**Reference:** [`Message layout` in docs](/ton/messages/internal-messages)
