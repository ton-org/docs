...
```
**Note:**
- In this example, we use the literal `a` to obtain an address. More details on string literals can be found in the [documentation](/language/func/literals_identifiers#string-literals).
...
```
**Note:**
- The literal `a` is used to obtain an address. See the [documentation](/language/func/literals_identifiers#string-literals) for details on string literals.
