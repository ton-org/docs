...
local and global variables and changes to [control registers](/ton/whitepapers/tvm#1-3-2-list-of-control-registers)
...
However, certain [TVM state components](/ton/whitepapers/tvm#1-4-total-state-of-tvm-scccg) are **not** rolled back, such as:
...
<Aside
  type="danger"
>
  I am not sure if "Codepage settings" and "gas counters" refer to some [TVM state component](/ton/whitepapers/tvm#1-4-total-state-of-tvm-scccg)
</Aside>
