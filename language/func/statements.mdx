...
local and global variables and changes to [control registers](/ton/tvm#1-3-2-list-of-control-registers) 
...
However, certain [TVM state components](/ton/tvm#1-4-total-state-of-tvm-scccg) are **not** rolled back, such as:
- Codepage settings
- Gas counters

<Aside type="danger">
  I am not sure if "Codepage settings" and "gas counters" refer to some [TVM state component](/ton/tvm#1-4-total-state-of-tvm-scccg)
</Aside>
