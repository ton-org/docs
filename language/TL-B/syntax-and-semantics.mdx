...
For example, each address in TON could be either an **internal** message or an **external**, see [general info page](/ton/addresses/addresses-general-info).
...
as combinator's field. Only identifiers of the `Nat` and `Type` types can be parameters.
