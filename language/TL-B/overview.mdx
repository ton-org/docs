...
It is recommended to start by studying the [syntax and semantics of TL-B](/language/TL-B/syntax-and-semantics), simultaneously exploring each example through a convenient [TL-B online editor](https://ton-community.github.io/tlb-editor/#/main). To further your understanding, we recommend referring to [the page](/language/TL-B/complex-and-non-trivial-examples) that describes the most complex examples of TL-B schemes.
