...
The [TL-B online editor](https://ton-community.github.io/tlb-editor/#/main) allows you to write TL-B schemes and immediately see the results of parsing and serialization.
