...
Several methods operate on constant [string](/languages/tolk/types/strings) literals. They require constant inputs and are evaluated at compile type.
...
- `reflect.serializationPrefixOf<T>()` — serialization prefix/len of a struct.
