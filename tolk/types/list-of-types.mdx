...
- [strings](/languages/tolk/types/strings) — string values stored as snaked cells.
...
- [unknown](/languages/tolk/types/unknown) — "any value", any TVM single-slot primitive.
...
Smart contracts run on a stack-based virtual machine, [TVM](/tvm/overview), which imposes specific rules on how values are represented at runtime. For example, [strings](/languages/tolk/types/strings) are stored as snaked cells, because TVM has no native string support.
