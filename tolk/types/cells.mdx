...
<Aside type="note">
  Tolk has a dedicated [`string`](/languages/tolk/types/strings) type backed by snaked cells. The examples below show how to embed constant slices for low-level binary data.
</Aside>
