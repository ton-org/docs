...
- **Whitelist of trusted jetton masters**: List of jetton master contract addresses to accept
- **Deposit wallet address**: Service wallet (e.g., wallet v4 or v5)

### Initial configuration

1. For each whitelisted jetton master, derive the jetton wallet address for the deposit wallet using the master contract's `get_wallet_address()` method
...
1. Get the jetton master address from the whitelist
...
- Always verify the jetton master address against the whitelist
