...
**Initial value**: `Quit` — special continuation which terminates TVM with exit code `0`
...
**Initial value**: `Quit` — special continuation which terminates TVM with exit code `1`
...
**Initial value**: `ExcQuit` — special continuation which terminates TVM with an exception.
