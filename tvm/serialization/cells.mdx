...
A cell's level affects the number of higher hashes it has, see the [section on hashes](./hashes) for details.
...
However, the serialization of trees formed by cells is arranged differently, see [bag of cells](./bag_of_cells) for details.
