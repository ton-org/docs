...
Pruned branches cells are cells that represent deleted subtrees of tree of cells, see [the corresponding page](/ton/cells/prunned-branch-cells).
...
- Next, `h * 32` bytes store [representations hashes](/tvm/serialization/cells) of roots of the pruned subtrees starting 
