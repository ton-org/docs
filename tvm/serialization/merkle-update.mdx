...
Merkle update cells always have two references `c1`, `c2` and behave like a Merkle proof for both. See [merkel update cells page](/ton/cells/merkle-update-cells)
...
- the 256-bits first [higher hash](higher-hashes) of the referenced cell `c1` or the [representation hash](/tvm/serialization/cells) of `c` if its level equals zero;
