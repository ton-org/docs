...
Library cells are mainly used to minimize storage costs for accounts with identical code. Read more about this [pattern](/patterns/using-onchain-libraries).
