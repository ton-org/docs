...
These events are not implemented yet. Possible stack layout for split/merge events is described in [TON Blockchain](/foundations/whitepapers/tblkch#4-4-8-processing-split-prepare-transactions) whitepaper. However, it is a subject to change.
