...
<Aside>
  This page currently gives code examples in [Tact language](/languages/tact). They will be rewritten in [Tolk](/languages/tolk) in the [near future](https://github.com/tact-lang/mintlify-ton-docs/issues/727).
</Aside>
