...
TODO: add more links to tolk docs!
...
Follow the link in the console to see your contract on the **TON Viewer**. Blockchain explorers like [Tonviewer](/ecosystem/explorers/tonviewer) allow you to inspect transactions, smart contracts, and account states on the TON blockchain.
...
To run this script:
```bash
npx blueprint run getCounter --testnet
```
