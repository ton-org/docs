...
Build, deploy, and interact with a TON smart contract from scratch.
...
- **TON wallet** — you will set this up in Step 5.
...
Replace `<CONTRACT_ADDRESS>` with the address printed after deployment in Step 5.
...
You can view it at https://testnet.tonviewer.com/transaction/fe6380dc2e4fab5c2caf41164d204e2f41bebe7a3ad2cb258803759be41b5734 (transaction ID shown in full).
```
...
To call a get method, use `provider.get(METHOD_NAME)`:
