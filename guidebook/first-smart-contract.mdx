...
A **smart contract** isz a computer program stored on [TON Blockchain](/ton/overview) — distributed database that many computers maintain together. It runs on the [TVM](/tvm/overview) (TON Virtual Machine) — the "computer" that runs smart contract code on TON.
