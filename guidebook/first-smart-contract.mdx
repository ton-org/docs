...
We'll use [**Tolk**](/language/tolk) to implement this. Tolk looks familiar if you know JavaScript, but it's designed specifically for smart contract development.
