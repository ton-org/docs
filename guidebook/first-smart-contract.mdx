...
A **smart contract** is simply a computer program stored on [TON Blockchain](/ton/overview) -- distributed database that many computers maintain together. It is running by [TVM](/tvm/overview) (TON Virtual Machine) -- the "computer" that runs smart contract code on TON.
