...
[The limit](https://github.com/ton-blockchain/ton/blob/master/crypto/block/mc-config.h#L389) is 65536 unique cells per message or contract storage. Given that every cell is up to 1023 bits that sets hard upper limit.
...
|:--------------------------------------|-----------------------|---------------------------------------------------------------------------------------------------------------|
| Blockchain interaction, RPC client    | Ethers, Web3.js, Viem | [\@ton/ton](https://www.npmjs.com/package/@ton/ton), [Asset-sdk](https://github.com/ton-community/assets-sdk) |
| Low-level RPC client                  | Viem                  | [\@ton/ton](https://www.npmjs.com/package/@ton/ton)                                                           |
