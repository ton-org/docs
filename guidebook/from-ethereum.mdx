...
| :------------------------------------ | ------------------------ | ---------------
| Blockchain interaction                | Ethers, Web3.js          | [TonWeb](https://www.npmjs.com/package/tonweb)
...
| Local node                            | Ganache, Anvil           | [MyLocalTon](https://github.com/neodix42/MyLocalTon)
| Reusable contracts                    | \@openzeppelin/contracts | [Asset-sdk](https://github.com/ton-community/assets-sdk)
...
|-----------------------------------------|------------------|-------------------------------------------------------|
| User-friendly explorer                  | Etherscan        | [Tonviewer](https://tonviewer.com/)                   |
...
| Visual transaction composer             | -                | [Act](https://act.ghwnd.cc/)                          |
