...
sidebarTitle: In-wallet browsers and browser extensions
documentation: >-
...
- [TON Connect Bridge](#ton-connect-bridge) — describes the JavaScript bridge and how to use it
...
- `bridge`: An array specifying connectivity options between dApps and the wallet. Your custodian will use the JavaScript bridge, you should include:
  ...
  There, `key` points to the TON Connect Bridge implementation as discussed in the previous section.
