...
> THIS PAGE IN TON DOCS: https://docs.ton.org/v3/guidelines/dapps/tma/tutorials/step-by-step-guide
...
2. Once the script is connected, the **[window.Telegram.WebApp](https://core.telegram.org/bots/webapps#initializing-web-apps)** object becomes available. Learn more about creating Mini App using [`telegram-web-app.js`](/guidelines/dapps/tma/tutorials/app-examples#basic-tma-example) here.
...
Find a guide for `@twa-dev/sdk` [here](/guidelines/dapps/tma/tutorials/app-examples#modern-tma-example).
