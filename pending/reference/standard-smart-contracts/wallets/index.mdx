...
> THIS PAGE IN TON DOCS: https://docs.ton.org/v3/documentation/smart-contracts/contracts-specs/wallet-contracts
...
- [Message management](/documentation/smart-contracts/message-management/messages-and-transactions), because this is the main functionality of the wallets.
- [FunC language](/documentation/smart-contracts/func/overview), because we will heavily rely on implementations made using it.
...
- [addresses-in-ton-blockchain](/documentation/smart-contracts/addresses#workchain-id-and-account-id)
- [send-a-deploy-message](/documentation/smart-contracts/func/cookbook#how-to-send-a-deploy-message-with-stateinit-only-with-stateinit-and-body)
- [internal-message-layout](/documentation/smart-contracts/message-management/sending-messages#message-layout)
</Aside>
...
<Aside>
Note that the maximum number of actions is 255; this is a consequence of the realization through the [c5](/documentation/tvm/tvm-overview#results-of-tvm-execution) TVM register. Technically, you can make a request with empty `OutAction` and `ExtendedAction`, but in that case, it will be similar to just receiving funds.
</Aside>
...
When working with many messages in a short period, there is a need for special wallet called Highload Wallet. Read [the article](/documentation/smart-contracts/contracts-specs/highload-wallet) for more information.
...
- [Working with wallet smart contracts](/guidelines/smart-contracts/howto/wallet)
