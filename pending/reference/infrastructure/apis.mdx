---
title: "Various indexers and APIs for working with TON Blockchain"
sidebarTitle: "Indexers and APIs"
---

import { Aside } from '/snippets/aside.jsx';

> TODO: rewrite while clearly emphasizing this one: TON Center HTTP API
...
2. ADNL connection - Connect to a [liteserver](/guidelines/nodes/running-nodes/liteserver-node). While it may be inaccessible at times, it cannot provide false data due to library-implemented validation.
...
- ❌ HTTP-middleware dependency - Server responses cannot be fully trusted unless augmented with [merkle proofs](/documentation/data-formats/tlb/proofs) to verify authenticity.
...
- [nownodes.io](https://nownodes.io/nodes) — Provides full nodes and block explorers via API.
