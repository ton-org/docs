...
## 3.1 Install Archival Node with Liteserver
...
<Accordion title="Java (ton4j)">
```java
// Placeholder
```
</Accordion>

<Accordion title="Golang (tonutils-go)">
```bash
...
<Accordion title="Python (pytoniq)">
```bash
...
<Accordion title="JavaScript (ton-lite-client)">
```bash
