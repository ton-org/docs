---
title: "Integrate a React dApp with TON"
sidebarTitle: "React"
---
...
The recommended SDK for React dApps is `@tonconnect/ui-react`. It is a React component that provides a high-level way to interact with TON Connect.
