...
This document provides instructions for integrating TON Connect into custodian services.

## Table of Contents

- [What is TON Connect](#what-is-ton-connect) — introduction to the protocol and its role in the TON ecosystem
- [TON Connect Bridge](#ton-connect-bridge) — describes the bridge service and how to set it up
- [TON Connect Manifest](#ton-connect-manifest) — describes the manifest and how to create it
- [TON Connect Protocol](#ton-connect-protocol) — describes the protocol and how to implement it
- [TON Connect Signing](#ton-connect-signing) — describes the signing process and provides reference implementations
- [Support and Assistance](#support-and-assistance) — describes how to get help and schedule technical consultations
- [FAQ](#faq) — frequently asked questions about TON Connect implementation
...
- Reference Implementations
  ...
  - [TON Connect Bridge](https://github.com/ton-connect/bridge2)
...
TON Connect is the standard wallet connection protocol for The Open Network blockchain, similar to WalletConnect on Ethereum. It enables secure communication between wallets and decentralized applications, allowing users to authorize transactions while maintaining control of their private keys.
...
For technical architecture details: [TON Connect Protocol Documentation](https://github.com/ton-blockchain/ton-connect).

## TON Connect Manifest

A TON Connect manifest is a JSON configuration that defines how your wallet interacts with the TON Connect.

### Manifest Structure

Here is an example of a custodian TON Connect manifest:
...
- `bridge`: An array specifying connectivity options between dApps and the wallet. Your custodian will use the HTTP bridge, you should include:
  ...
  There, `url` points to the TON Connect Bridge implementation as discussed in the previous section.
...
A TON Connect Bridge serves as a transport mechanism for delivering messages between applications (dApps) and wallets. It enables end-to-end encrypted communication where neither party needs to be online simultaneously.
...
For this option, you can deploy the [official TON Connect Bridge implementation](https://github.com/ton-connect/bridge).
...
For implementing ton_proof functionality, two key resources are available:
...
- **Mainnet:** `-239`, `CHAIN.MAINNET`
- **Testnet:** `-3`, `CHAIN.TESTNET`
