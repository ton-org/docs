...
<Callout
  type="note"
  title="Since April 9, 2026"
>
  With the implementation of the [new consensus protocol](/foundations/whitepapers/simplex), TON Blockchain produces new blocks in [under a second](/subsecond).
</Callout>
