...
If you’ve just sent a message, it usually takes no more than a second before it appears on-chain. The function `waitForTransaction` to poll the blockchain and wait for the corresponding transaction should be used in this case:
