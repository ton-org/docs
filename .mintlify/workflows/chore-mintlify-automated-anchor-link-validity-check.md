...
Go over all mdx pages and check the relative anchor links that start with #. For example, [dummy link](#some-anchor). Try to fix all anchors that do not point to the correct location.
